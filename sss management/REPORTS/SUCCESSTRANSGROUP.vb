...
Public Class SUCCESSTRANSGROUP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.SUCCESSTRANSGROUP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSUCCESSTRANSGROUP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SUCCESSTRANSGROUP = New SUCCESSTRANSGROUP()
        rpt.Site = Me.Site
        Return rpt
    End Function
