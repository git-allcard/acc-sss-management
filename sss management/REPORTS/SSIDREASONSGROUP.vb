...
Public Class SSIDREASONSGROUP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.SSIDREASONSGROUP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSSIDREASONSGROUP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SSIDREASONSGROUP = New SSIDREASONSGROUP()
        rpt.Site = Me.Site
        Return rpt
    End Function
