...
Public Class FIGFAILGROUP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.FIGFAILGROUP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFIGFAILGROUP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FIGFAILGROUP = New FIGFAILGROUP()
        rpt.Site = Me.Site
        Return rpt
    End Function
