...
Public Class FIGTRBRMONTHLY
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.FIGTRBRMONTHLY.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFIGTRBRMONTHLY
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FIGTRBRMONTHLY = New FIGTRBRMONTHLY()
        rpt.Site = Me.Site
        Return rpt
    End Function
