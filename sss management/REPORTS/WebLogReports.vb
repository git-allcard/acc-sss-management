...
Public Class WebLogReports
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.WebLogReports.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedWebLogReports
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As WebLogReports = New WebLogReports()
        rpt.Site = Me.Site
        Return rpt
    End Function
