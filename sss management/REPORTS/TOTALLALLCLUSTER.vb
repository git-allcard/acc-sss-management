...
Public Class TOTALLALLCLUSTER
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.TOTALLALLCLUSTER.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTOTALLALLCLUSTER
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TOTALLALLCLUSTER = New TOTALLALLCLUSTER()
        rpt.Site = Me.Site
        Return rpt
    End Function
