...
Public Class TRANSUSINGGSIS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.TRANSUSINGGSIS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTRANSUSINGGSIS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TRANSUSINGGSIS = New TRANSUSINGGSIS()
        rpt.Site = Me.Site
        Return rpt
    End Function
