...
Public Class SUCFAILEDCLUST
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.SUCFAILEDCLUST.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSUCFAILEDCLUST
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SUCFAILEDCLUST = New SUCFAILEDCLUST()
        rpt.Site = Me.Site
        Return rpt
    End Function
