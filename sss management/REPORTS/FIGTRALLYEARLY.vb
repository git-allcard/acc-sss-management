...
Public Class FIGTRALLYEARLY
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.FIGTRALLYEARLY.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFIGTRALLYEARLY
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FIGTRALLYEARLY = New FIGTRALLYEARLY()
        rpt.Site = Me.Site
        Return rpt
    End Function
