...
Public Class PRINTKIOSKFB
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.PRINTKIOSKFB.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPRINTKIOSKFB
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PRINTKIOSKFB = New PRINTKIOSKFB()
        rpt.Site = Me.Site
        Return rpt
    End Function
