...
Public Class SALLOANEMPALL
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.SALLOANEMPALL.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSALLOANEMPALL
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SALLOANEMPALL = New SALLOANEMPALL()
        rpt.Site = Me.Site
        Return rpt
    End Function
