...
Public Class SSIDALLGROUP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.SSIDALLGROUP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSSIDALLGROUP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SSIDALLGROUP = New SSIDALLGROUP()
        rpt.Site = Me.Site
        Return rpt
    End Function
