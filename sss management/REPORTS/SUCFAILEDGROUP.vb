...
Public Class SUCFAILEDGROUP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.SUCFAILEDGROUP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSUCFAILEDGROUP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SUCFAILEDGROUP = New SUCFAILEDGROUP()
        rpt.Site = Me.Site
        Return rpt
    End Function
