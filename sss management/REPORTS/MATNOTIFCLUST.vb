...
Public Class MATNOTIFCLUST
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.MATNOTIFCLUST.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMATNOTIFCLUST
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MATNOTIFCLUST = New MATNOTIFCLUST()
        rpt.Site = Me.Site
        Return rpt
    End Function
