...
Public Class SSIDLOGSGROUP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.SSIDLOGSGROUP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSSIDLOGSGROUP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SSIDLOGSGROUP = New SSIDLOGSGROUP()
        rpt.Site = Me.Site
        Return rpt
    End Function
