...
Public Class FIGREGBRANCH
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.FIGREGBRANCH.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFIGREGBRANCH
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FIGREGBRANCH = New FIGREGBRANCH()
        rpt.Site = Me.Site
        Return rpt
    End Function
