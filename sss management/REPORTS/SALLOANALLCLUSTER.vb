...
Public Class SALLOANALLCLUSTER
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.SALLOANALLCLUSTER.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSALLOANALLCLUSTER
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SALLOANALLCLUSTER = New SALLOANALLCLUSTER()
        rpt.Site = Me.Site
        Return rpt
    End Function
