...
Public Class TECHRETREGGROUP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.TECHRETREGGROUP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTECHRETREGGROUP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TECHRETREGGROUP = New TECHRETREGGROUP()
        rpt.Site = Me.Site
        Return rpt
    End Function
