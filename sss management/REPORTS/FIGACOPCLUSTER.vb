...
Public Class FIGACOPCLUSTER
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.FIGACOPCLUSTER.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFIGACOPCLUSTER
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FIGACOPCLUSTER = New FIGACOPCLUSTER()
        rpt.Site = Me.Site
        Return rpt
    End Function
