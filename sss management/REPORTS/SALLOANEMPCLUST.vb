...
Public Class SALLOANEMPCLUST
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.SALLOANEMPCLUST.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSALLOANEMPCLUST
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SALLOANEMPCLUST = New SALLOANEMPCLUST()
        rpt.Site = Me.Site
        Return rpt
    End Function
