...
Public Class FIGACOPDEPALL
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.FIGACOPDEPALL.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFIGACOPDEPALL
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FIGACOPDEPALL = New FIGACOPDEPALL()
        rpt.Site = Me.Site
        Return rpt
    End Function
