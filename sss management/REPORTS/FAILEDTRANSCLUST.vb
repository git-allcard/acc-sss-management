...
Public Class FAILEDTRANSCLUST
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.FAILEDTRANSCLUST.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_getCluster() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedFAILEDTRANSCLUST
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FAILEDTRANSCLUST = New FAILEDTRANSCLUST()
        rpt.Site = Me.Site
        Return rpt
    End Function
