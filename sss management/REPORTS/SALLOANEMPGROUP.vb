...
Public Class SALLOANEMPGROUP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.SALLOANEMPGROUP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSALLOANEMPGROUP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SALLOANEMPGROUP = New SALLOANEMPGROUP()
        rpt.Site = Me.Site
        Return rpt
    End Function
