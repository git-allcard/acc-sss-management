...
Public Class TECHRETCLUST
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.TECHRETCLUST.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTECHRETCLUST
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TECHRETCLUST = New TECHRETCLUST()
        rpt.Site = Me.Site
        Return rpt
    End Function
