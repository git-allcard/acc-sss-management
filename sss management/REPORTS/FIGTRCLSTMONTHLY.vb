...
Public Class FIGTRCLSTMONTHLY
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.FIGTRCLSTMONTHLY.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFIGTRCLSTMONTHLY
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FIGTRCLSTMONTHLY = New FIGTRCLSTMONTHLY()
        rpt.Site = Me.Site
        Return rpt
    End Function
