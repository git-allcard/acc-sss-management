...
Public Class FIGTECHRETBRANCH
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.FIGTECHRETBRANCH.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFIGTECHRETBRANCH
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FIGTECHRETBRANCH = New FIGTECHRETBRANCH()
        rpt.Site = Me.Site
        Return rpt
    End Function
