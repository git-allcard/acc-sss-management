...
Public Class SICKMATGROUP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.SICKMATGROUP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSICKMATGROUP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SICKMATGROUP = New SICKMATGROUP()
        rpt.Site = Me.Site
        Return rpt
    End Function
