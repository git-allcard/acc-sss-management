...
Public Class TECHRETLUMPBRANCH
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.TECHRETLUMPBRANCH.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTECHRETLUMPBRANCH
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TECHRETLUMPBRANCH = New TECHRETLUMPBRANCH()
        rpt.Site = Me.Site
        Return rpt
    End Function
