...
Public Class SALLOANVOLGROUP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.SALLOANVOLGROUP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSALLOANVOLGROUP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SALLOANVOLGROUP = New SALLOANVOLGROUP()
        rpt.Site = Me.Site
        Return rpt
    End Function
