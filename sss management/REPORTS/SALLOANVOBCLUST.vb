...
Public Class SALLOANVOBCLUST
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.SALLOANVOBCLUST.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSALLOANVOBCLUST
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SALLOANVOBCLUST = New SALLOANVOBCLUST()
        rpt.Site = Me.Site
        Return rpt
    End Function
