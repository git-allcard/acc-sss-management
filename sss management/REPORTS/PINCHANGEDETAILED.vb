...
Public Class PINCHANGEDETAILED
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.PINCHANGEDETAILED.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPINCHANGEDETAILED
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PINCHANGEDETAILED = New PINCHANGEDETAILED()
        rpt.Site = Me.Site
        Return rpt
    End Function
