...
Public Class NewMonitoringAll
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.NewMonitoringAll.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedNewMonitoringAll
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As NewMonitoringAll = New NewMonitoringAll()
        rpt.Site = Me.Site
        Return rpt
    End Function
