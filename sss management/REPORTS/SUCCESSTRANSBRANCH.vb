...
Public Class SUCCESSTRANSBRANCH
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.SUCCESSTRANSBRANCH.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSUCCESSTRANSBRANCH
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SUCCESSTRANSBRANCH = New SUCCESSTRANSBRANCH()
        rpt.Site = Me.Site
        Return rpt
    End Function
