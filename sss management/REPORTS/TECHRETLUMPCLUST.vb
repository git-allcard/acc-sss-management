...
Public Class TECHRETLUMPCLUST
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.TECHRETLUMPCLUST.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTECHRETLUMPCLUST
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TECHRETLUMPCLUST = New TECHRETLUMPCLUST()
        rpt.Site = Me.Site
        Return rpt
    End Function
