...
Public Class SSIDLOGSCLUSTER
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.SSIDLOGSCLUSTER.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSSIDLOGSCLUSTER
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SSIDLOGSCLUSTER = New SSIDLOGSCLUSTER()
        rpt.Site = Me.Site
        Return rpt
    End Function
