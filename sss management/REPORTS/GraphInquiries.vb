...
Public Class GraphInquiries
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.GraphInquiries.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGraphInquiries
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GraphInquiries = New GraphInquiries()
        rpt.Site = Me.Site
        Return rpt
    End Function
