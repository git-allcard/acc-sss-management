...
Public Class SSIDLOGSBRANCH
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.SSIDLOGSBRANCH.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSSIDLOGSBRANCH
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SSIDLOGSBRANCH = New SSIDLOGSBRANCH()
        rpt.Site = Me.Site
        Return rpt
    End Function
