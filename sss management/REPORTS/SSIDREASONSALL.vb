...
Public Class SSIDREASONSALL
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.SSIDREASONSALL.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSSIDREASONSALL
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SSIDREASONSALL = New SSIDREASONSALL()
        rpt.Site = Me.Site
        Return rpt
    End Function
