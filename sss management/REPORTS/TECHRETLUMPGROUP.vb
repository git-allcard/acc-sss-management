...
Public Class TECHRETLUMPGROUP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.TECHRETLUMPGROUP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTECHRETLUMPGROUP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TECHRETLUMPGROUP = New TECHRETLUMPGROUP()
        rpt.Site = Me.Site
        Return rpt
    End Function
