...
Public Class SALLOANSEGROUP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.SALLOANSEGROUP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSALLOANSEGROUP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SALLOANSEGROUP = New SALLOANSEGROUP()
        rpt.Site = Me.Site
        Return rpt
    End Function
