...
Public Class WebLogCluster
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.WebLogCluster.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedWebLogCluster
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As WebLogCluster = New WebLogCluster()
        rpt.Site = Me.Site
        Return rpt
    End Function
