...
Public Class Eligibilityall
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.Eligibilityall.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEligibilityall
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Eligibilityall = New Eligibilityall()
        rpt.Site = Me.Site
        Return rpt
    End Function
