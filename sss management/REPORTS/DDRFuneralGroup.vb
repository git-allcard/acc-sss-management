...
Public Class DDRFuneralGroup
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.DDRFuneralGroup.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDDRFuneralGroup
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DDRFuneralGroup = New DDRFuneralGroup()
        rpt.Site = Me.Site
        Return rpt
    End Function
