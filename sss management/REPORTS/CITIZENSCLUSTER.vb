...
Public Class CITIZENSCLUSTER
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.CITIZENSCLUSTER.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCITIZENSCLUSTER
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CITIZENSCLUSTER = New CITIZENSCLUSTER()
        rpt.Site = Me.Site
        Return rpt
    End Function
