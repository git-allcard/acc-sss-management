...
Public Class CITIZENSBRANCH
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.CITIZENSBRANCH.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCITIZENSBRANCH
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CITIZENSBRANCH = New CITIZENSBRANCH()
        rpt.Site = Me.Site
        Return rpt
    End Function
