...
Public Class MonthyDowntimeRpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.MonthyDowntimeRpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMonthyDowntimeRpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MonthyDowntimeRpt = New MonthyDowntimeRpt()
        rpt.Site = Me.Site
        Return rpt
    End Function
