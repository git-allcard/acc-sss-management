...
Public Class SSIDALLCLUSTER
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.SSIDALLCLUSTER.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSSIDALLCLUSTER
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SSIDALLCLUSTER = New SSIDALLCLUSTER()
        rpt.Site = Me.Site
        Return rpt
    End Function
