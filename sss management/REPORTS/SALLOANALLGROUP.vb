...
Public Class SALLOANALLGROUP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.SALLOANALLGROUP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSALLOANALLGROUP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SALLOANALLGROUP = New SALLOANALLGROUP()
        rpt.Site = Me.Site
        Return rpt
    End Function
