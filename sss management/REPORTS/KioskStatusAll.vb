...
Public Class KioskStatusAll
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.KioskStatusAll.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedKioskStatusAll
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As KioskStatusAll = New KioskStatusAll()
        rpt.Site = Me.Site
        Return rpt
    End Function
