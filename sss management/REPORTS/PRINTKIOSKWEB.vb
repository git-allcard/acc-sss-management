...
Public Class PRINTKIOSKWEB
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.PRINTKIOSKWEB.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_getDate() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedPRINTKIOSKWEB
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PRINTKIOSKWEB = New PRINTKIOSKWEB()
        rpt.Site = Me.Site
        Return rpt
    End Function
