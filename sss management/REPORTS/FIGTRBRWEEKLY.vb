...
Public Class FIGTRBRWEEKLY
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.FIGTRBRWEEKLY.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFIGTRBRWEEKLY
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FIGTRBRWEEKLY = New FIGTRBRWEEKLY()
        rpt.Site = Me.Site
        Return rpt
    End Function
