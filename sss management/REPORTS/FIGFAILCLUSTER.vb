...
Public Class FIGFAILCLUSTER
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.FIGFAILCLUSTER.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFIGFAILCLUSTER
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FIGFAILCLUSTER = New FIGFAILCLUSTER()
        rpt.Site = Me.Site
        Return rpt
    End Function
