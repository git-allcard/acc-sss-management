...
Public Class SALLOANSECLUST
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.SALLOANSECLUST.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSALLOANSECLUST
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SALLOANSECLUST = New SALLOANSECLUST()
        rpt.Site = Me.Site
        Return rpt
    End Function
