...
Public Class FIGTECHRETGROUP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.FIGTECHRETGROUP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFIGTECHRETGROUP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FIGTECHRETGROUP = New FIGTECHRETGROUP()
        rpt.Site = Me.Site
        Return rpt
    End Function
