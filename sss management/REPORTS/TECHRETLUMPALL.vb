...
Public Class TECHRETLUMPALL
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.TECHRETLUMPALL.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTECHRETLUMPALL
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TECHRETLUMPALL = New TECHRETLUMPALL()
        rpt.Site = Me.Site
        Return rpt
    End Function
