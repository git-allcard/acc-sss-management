...
Public Class TOTALALLGROUP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.TOTALALLGROUP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTOTALALLGROUP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TOTALALLGROUP = New TOTALALLGROUP()
        rpt.Site = Me.Site
        Return rpt
    End Function
