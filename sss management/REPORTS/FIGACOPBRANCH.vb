...
Public Class FIGACOPBRANCH
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.FIGACOPBRANCH.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFIGACOPBRANCH
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FIGACOPBRANCH = New FIGACOPBRANCH()
        rpt.Site = Me.Site
        Return rpt
    End Function
