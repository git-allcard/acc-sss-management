...
Public Class WebLogBranch
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.WebLogBranch.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedWebLogBranch
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As WebLogBranch = New WebLogBranch()
        rpt.Site = Me.Site
        Return rpt
    End Function
