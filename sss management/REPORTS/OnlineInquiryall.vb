...
Public Class OnlineInquiryall
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.OnlineInquiryall.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedOnlineInquiryall
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As OnlineInquiryall = New OnlineInquiryall()
        rpt.Site = Me.Site
        Return rpt
    End Function
