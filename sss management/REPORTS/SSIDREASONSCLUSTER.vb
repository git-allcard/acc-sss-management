...
Public Class SSIDREASONSCLUSTER
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.SSIDREASONSCLUSTER.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSSIDREASONSCLUSTER
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SSIDREASONSCLUSTER = New SSIDREASONSCLUSTER()
        rpt.Site = Me.Site
        Return rpt
    End Function
