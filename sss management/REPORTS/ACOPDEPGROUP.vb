...
Public Class ACOPDEPGROUP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.ACOPDEPGROUP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedACOPDEPGROUP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ACOPDEPGROUP = New ACOPDEPGROUP()
        rpt.Site = Me.Site
        Return rpt
    End Function
