...
Public Class FEEDBACKKIOSK
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.FEEDBACKKIOSK.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFEEDBACKKIOSK
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FEEDBACKKIOSK = New FEEDBACKKIOSK()
        rpt.Site = Me.Site
        Return rpt
    End Function
