...
Public Class CHANGEOFADDALL
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.CHANGEOFADDALL.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCHANGEOFADDALL
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CHANGEOFADDALL = New CHANGEOFADDALL()
        rpt.Site = Me.Site
        Return rpt
    End Function
