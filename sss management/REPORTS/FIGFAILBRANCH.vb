...
Public Class FIGFAILBRANCH
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "sss_management.FIGFAILBRANCH.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFIGFAILBRANCH
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FIGFAILBRANCH = New FIGFAILBRANCH()
        rpt.Site = Me.Site
        Return rpt
    End Function
